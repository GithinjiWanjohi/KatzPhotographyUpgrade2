...
<header id="home">
  ...
  <!-- Start about-1-page area -->
  <div class="about_slider-area pt-90">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <div class="slider-text-2 text-center pt-40">
            <h2 class="color-w font-w-8 font-40 pb-20">ABOUT US</h2>
            <h4 class="color-w font-22"><a class="font-20 color-w" href="index.html">Home</a> <span class="plr-10"><i class="fa fa-angle-right"></i><i class="fa fa-angle-right"></i></span>About Us</h4>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="about_1-area-section">
          <div class="col-md-6">
            <h3 class="pb-20 font-w-8 font-30">Welcome to KATZ Photography</h3>
            <p class="ln-h-30 font-w-6">Wedding Photography is more than just images. Our approach to a wedding is that it should not be a photo shoot!</p>
            <p class="ln-h-30 font-w-6">Telling your story with images that have authentic moments is all we are up to. We are driven to remind you the true emotions of how it felt like looking at your wedding photos many years later. We are all about creative story telling with images. It’s “Creative Documentary Wedding Photography!”</p>
            <p class="ln-h-30 font-w-6">We are a husband and wife wedding photography team based in Nairobi, Kenya and we are passionate story tellers…with images!</p>
            <p class="ln-h-30 font-w-6">We are Monicah and Timothy Katua.</p>
          </div>
          <div class="col-md-6"> <img src="images/About/001.jpg" class="img-responsive" alt=""> </div>
        </div>
        <div class="clearfix"></div>
        <div class="about_1-area-section mt-40">
          <div class="col-md-6"> <img src="images/About/002.jpg" class="img-responsive" alt=""> </div>
          <div class="col-md-6">
            <h3 class="pb-20 font-w-8 font-30 pt-15">Our Mission And Vision</h3>
            <p class="ln-h-30 font-w-6">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries</p>
            <p class="ln-h-30 font-w-6">It is a long established fact that a reader will be distracted by the readable content of a page when looking at its layout. The point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using 'Content here, content here', making it look like readable English. Many desktop publishing packages</p>
          </div>
        </div>
      </div>
    </div>
